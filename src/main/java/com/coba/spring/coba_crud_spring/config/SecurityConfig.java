...
//        conf.setAllowedOrigins(List.of("http.blablabla.com", "127.x.x.x:xxxx", "localhost:xxxx"));
        ...
        // Izinkan ngirim cookie/credentials
        conf.setAllowCredentials(true);

        // Nerapin semua konfigurasi ke semua route atau path (/**)
